...
Phaser.Keyboard = function (game) {
    ...
    */
    ...
    /**
     * @property {function} redirectKeyEventCallback
     */
    this.redirectKeyEventCallback = null;
...
Phaser.Keyboard.prototype = {
    ...
    */
    _processKeyEvent: function(event) {
        ...
        if(this.redirectKeyEventCallback) 
        {
            this.redirectKeyEventCallback.call(this.callbackContext,event);
            return;
        }
    ...
    */
     ...
     */
    setRedirect: function (callback) {

        if(typeof callback === 'function')
        {
            this.redirectKeyEventCallback = callback;
        }
